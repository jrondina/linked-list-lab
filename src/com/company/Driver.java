...
public class Driver {
	...
	public static void main(String[] args) {
		...
		//ArrayList is faster because LinkedList would still have to go through the list even though Smith is first
		...
		//ArrayList is faster because you're only changing one known position
		...
		//ArrayList is faster because you're changing one known position
